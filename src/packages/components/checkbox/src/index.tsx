  ...
  return () => (
    ...
    >
      <Icon
        ...
        name={v.value ? "k-icon-checkbox-fill" : "k-icon-checkbox"}
      />
      {slots.default && (
        <span class="k-checkbox-text">{slots.default?.()}</span>
      )}
    </span>
  )
}
  ...
  return () => (
    ...
    >
      <Icon
        class="k-checkbox-icon"
        name={
          v.value === symbol.value ? "k-icon-checkbox" : "k-icon-checkbox-fill"
        }
      />
      {slots.default && (
        <span class="k-checkbox-text">{slots.default?.()}</span>
